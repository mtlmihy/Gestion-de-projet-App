      ...
      <div className="max-w-screen-xl mx-auto px-4 h-14 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            title={projet ? 'Changer de projet' : 'Accueil projets'}
            aria-label={projet ? 'Changer de projet' : 'Accueil projets'}
          >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `inline-flex items-center justify-center w-9 h-9 rounded-lg border transition-colors ${
                  isActive
                    ? 'bg-gray-800 border-gray-800 dark:bg-slate-700 dark:border-slate-700 text-white'
                    : 'border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-400 hover:bg-gray-800 dark:hover:bg-slate-700 hover:text-white hover:border-gray-800 dark:hover:border-slate-700'
                }`
              }
            >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `inline-flex items-center justify-center w-10 h-10 rounded-lg border transition-colors ${
                  isActive
                    ? 'bg-gray-800 border-gray-800 dark:bg-slate-700 dark:border-slate-700 text-white'
                    : 'border-gray-200 dark:border-slate-700 text-gray-700 dark:text-slate-300 hover:bg-gray-800 dark:hover:bg-slate-700 hover:text-white hover:border-gray-800 dark:hover:border-slate-700'
                }`
              }
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
